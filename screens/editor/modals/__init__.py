...
__all__ = [
    "open_create_column_modal",       # legado — conservado por compatibilidad
    "open_create_variable_modal",     # nuevo: variables sin fórmula
    "open_create_formula_modal",      # nuevo: fórmulas con/sin error
