"""
Modal: Crear Complejo
Permite crear variables de tipo complejo con soporte de magnitudes y unidades.
"""
...
async def open_create_complex_modal(
    page,
    pool,
    columns_row,
    ...
    name_field = text_input(
        placeholder=tm.translate("Nombre variable (ej: z1, z_tot...)")
    )
    ...
    page.show_dialog(
        modal(
            title_str=tm.translate("Crear Complejo"),
            content=[
                dots_row,
                error_banner,
                step0,
